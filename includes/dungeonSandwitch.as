...
public function fenPutsHisShittyFetishInYoSphinx():void {
	...
	outputText("\n\nSanura folds her arms across her perky tits and rolls her eyes.  \"<i>You know, bent over, on the ground, ass-up and open?</i>\"  She blows a strand of black hair air of the way with an exasperated sigh.  \"<i>Just how long have you been in Mareth?  You know what?  Never mind, just get that " + assholeOffLimits("pussy", "ass") + " up so I can plow it.</i>\"");
	
	outputText("\n\nYou can't help but point out the obvious: she doesn't have a penis, at least not one you can see.");
	
	outputText("\n\n\"<i>So?</i>\"");
	
	outputText("\n\nWell, she can't really fuck your [" + assholeOffLimits("vagina", "asshole") + "] without one...");
	
	outputText("\n\nSanura laughs, \"<i>I'm a sphinx.  Reality is my plaything!  Go on...</i>\"  Her heavy forepaw falls on your shoulder, the soft, feline-like pads compressing soft and pillow-like against your " + player.skinFurScales() + ", forcing you down.  You lean over reluctantly and lift your [butt] towards the assertive lioness, shivering at how open and exposed you are like this, your [" + assholeOffLimits("vagina", "asshole") + "] puckered and ready to be plowed.  Her other paw comes down on your right shoulder, and the shadow of her muscular, leonine lower body falls across you, causing her warm body heat to wash over you.  Sanura's soft underfur brushes across your back, tickling you sensually as she gets in position.  Curling over your shoulders, her toes extend deadly looking claws, but they do no more than press against the top of your chest, securing you in place with cushy paw-pads and pointed threats.");
	
	outputText("\n\nTilting your head to the side, you try to look up above, but all you can see past her brustling belly-fur are the pert swells of her cleavage and a few swirling, ephemeral hexagons floating around her wrists while her fingers swivel with inhuman dexterity.  There's a barely audible 'fwoomp' followed by a tingling against your [" + assholeOffLimits("vagina", "asshole") + "], abruptly carrying its magical effervescence into your " + assholeOffLimits("vagina", "sphincter") + " as something flat and blunted butts up against it.  Your eyes open wide in surprise at the pressure on your " + assholeOffLimits("entrance", "backdoor") + ", something Sanura takes absolute delight in seeing, bending her human-half over to take in your expression while her forepaws push you harder onto her magical spear.");
	
	// The constant here allows for vaginal elasticity.
	var orificeCapacity:Number = assholeOffLimits(player.vaginalCapacity() * 1.5, player.analCapacity())
	
	//Big capable entrances 100+
	if(orificeCapacity >= 100) {
		outputText("\n\nYou will yourself to relax, and like magic, your [" + assholeOffLimits("vagina", "asshole") + "] stretches out to handle the elephantine force-cock with ease, devouring the flat, flared phallus straight " + assholeOffLimits("up to your cervix", "into your rectum") + ".  It distends your belly slightly as it pushes deeper, Sanura grunting when a middle ring catches for a second before popping in, rapt with the ecstasy your welcoming " + assholeOffLimits("cunt", "asshole") + " can provide.  She provides you with a lazy smile before straightening out and placing her hand on your head, stroking your " + hairDescript() + " and lazily patting you as she finally bottoms out, accompanied by the feeling of sparking, tingling nuts slapping hard into your [" + assholeOffLimits("clit", "butt") + "].");
		outputText("\n\n\"<i>Mmmm, I knew you'd be a good " + player.mf("boy","girl") + ".</i>\"");
	}
	//Medium capacity! 40+!
	else if(orificeCapacity >= 40) {
		outputText("\n\nYou will yourself to relax, but even so, your [" + assholeOffLimits("vagina", "asshole") + "] is stretched to its limit even before Sanura's flared force-cock can pop inside.  Whimpering in discomfort, you try to endure her forceful attempts at " + assholeOffLimits("", "butt") + "fucking.  She doesn't seem to have any such plans, smashing her fat, " + assholeOffLimits("cunt", "butt") + "-destroying horse-cock against you again and again, each time spreading your " + assholeOffLimits("pussy", "asshole") + " further, pounding your " + assholeOffLimits("entrance", "sphincter") + "'s structural integrity down into that of a weak, accepting " + assholeOffLimits("quim", "anus") + ".  You feel it bow under the pressure.  Growling, Sanura holds it there, pressing with such insistent strength that your entrance yields all at once; her member's brutal, bulging tip pops into your " + assholeOffLimits("vagina", "rectum") + ".  She doesn't stop there.  Inch after inch of tingling, phantasmal dong is pushed straight up your straining " + assholeOffLimits("vagina", "rectum") + ", only pausing for a brief moment when the swollen middle ring catches for a half-second.");
		outputText("\n\nElectrically charged balls the size of large melons plop against your [" + assholeOffLimits("clit", "butt") + "] as she bottoms out.  \"<i>Mmmm, I knew you'd be a good " + player.mf("boy","girl") + ".</i>\" Sanura purrs, patting you on the head.");
	}
	//Lowish Capacity
	else {
		outputText("\n\nYou will yourself to relax, but you just aren't big enough " + assholeOffLimits("inside", "back there") + " to make much of a difference.  Just having such an immense dong pressing at your " + assholeOffLimits("entrance", "backdoor") + " is enough to push you to your limits, but your " + assholeOffLimits("vagina hasn't even stretched", "sphincter hasn't even dilated") + " enough to take a fraction of her girth.  Sanura growls in frustration and begins to hump at it, smacking the blunted tip into it again and again. The shocking sensation makes your " + assholeOffLimits("vaginal", "anal") + " muscles twitch, spasm, and relax as she works to plow her way through your more than token resistance.");
		//VIRGIN ALT: 
		if(assholeOffLimits(player.vaginas[0].vaginalLooseness, player.ass.analLooseness) == 0) {
			outputText("\n\nShe grunts, \"<i>Don't tell me you're a virgin?</i>\"  You nod and bite your lip as you try to endure.  Sanura stops immediately at that news, mulling it over with a detached expression, a smile slowly spreading across her features.  \"<i>Really?</i>\" she asks as her hips begin to slowly work at your " + assholeOffLimits("cunt", "ass") + " once more, slowly picking back up to their old tempo.  \"<i>Then it's a good thing you're getting to ride my magic cock and not some brute's.  It might hurt a little, but I promise this will be " + assholeOffLimits("", "butt") + "sex worth remembering....</i>\"");
		}
		//Non-virgin
		else outputText("\n\nShe grunts, \"<i>Gods, you're tighter than a virgin imp's asshole!</i>\"");
	}
	//Merge, no new PG
	outputText("\n\nThat's no small comfort to your poor, sore " + assholeOffLimits("vagina", "rectum") + ".  It's going to be left gaped by this monstrous woman in short order, pounded into open, stretched submission, just like its owner.  The pain of being opened up this forcefully is enough to bring a tear to your eye and a strange surge of excitement through your crotch.  How can you be enjoying this?  You don't have long to ponder it, your muscles are caving in underneath Sanura's " + assholeOffLimits("cunt", "butt") + "-battering fucking, slowly, inexorably stretching to handle her fat flare.  Gods!  You whimper as your [" + assholeOffLimits("vagina", "asshole") + "] abruptly gives up the ghost and allows Sanura's phantom member inside, inches of her tingly fuck-tool nestling inside you in seconds.");
	
	outputText("\n\nSanura straightens with an unseen smile, her hand playfully tangling with your " + hairDescript() + " as she hilts the rest of the way into your " + assholeOffLimits("battered bits", "abused anus") + ", not stopping until jiggling, magical nuts slap into your [" + assholeOffLimits("clit", "butt") + "].  \"<i>Atta " + player.mf("boy","girl") + ".  I thought for a moment that this might have been a waste of magic.  Now just settle in and enjoy it.</i>\"  You wince with the knowledge that somehow, you ARE enjoying it.  The pain seems to have faded with the magical buzzing in your " + assholeOffLimits("fuck", "butt") + "hole, and all that you're left with is a satisfied stretching and the friction that comes with it.");
	...
	outputText("\n\nThe " + assholeOffLimits("cunt", "butt") + "-breaking horse-cock releases enough cum into you to make your middle audibly gurgle and your belly begin to distend, flooding your " + assholeOffLimits("womb", "intestines") + " with tingles and liquid warmth.  Thankfully, Sanura slowly begins to pull out, even as she's cumming, her cock flexing in your brutalized " + assholeOffLimits("pussy", "asshole") + " for every inch it's pulled past, leaving enough goo in its wake that your innards never get to relax.");
	...
	else outputText("  When she's almost out, you give in and cum, quivering around her magical breeding tool while it finishes inseminating your " + assholeOffLimits("womb", "guts") + ".");
	outputText("  The head is so swollen that she actually struggles to pop it back out of your [" + assholeOffLimits("vagina", "asshole") + "], bouncing her hips back a few times with little success");
	if(player.cockTotal() > 0) outputText(" and dragging you through your fresh, milky puddle");
	outputText(".  Eventually, she gives a mighty, " + assholeOffLimits("pussy-pulling", "sphincter-stretching") + " lurch and ejects from your " + assholeOffLimits("mound", "[butt]") + ", painting it white on the way out.");
