...
public function dreamSelect():Boolean {
	...
	if(dreamtemp > 5) {
		...
		//minotaur cum
			...
			outputText("Your presence does not go unnoticed.  The owners of the caves step out of the shadows and you find yourself surrounded on all sides by the hulking, vulgar forms of minotaurs, their titanic cocks stiffening while their overfull balls sway heavily between their legs.  You don't remember how you got up here, but there is no way out.  A thrill of panic shoots up your spine and you try to call for help, but your voice catches in your throat, barely more than an impassioned whisper.  And then, they are upon you.  Coarse hands grab your arms and hips, throwing you into the small circle at the center of the mob, the oafish beasts crowding against each other to surround you.  They loom impossibly tall over you, the corded muscles of their barbarous chests hiding their faces from you, but you can hear them snorting in perverse impatience as they scuff their hooves on the ground, the flesh of their profane shafts engorged and straining in the air around you.\n\n", false);
		...
		//Scylla + dom + dong
			...
			outputText("waking in the middle of the night, your camp flooded with the pale fragile moonlight.  Shadows hiding just beyond your eyesight as you try to adjust to the low light.  The blurred shapes of the shadows seem to crawl and move as if alive.  A faint yellow light flashes like a wisp in the distance.  You rub your eyes as if to cast off the haze of the night.  Started by another flash, you get up from your bed, looking for you equipment.  Rummaging through your belongings hurriedly, the wind blows through your [hair], carrying a noise to your ears.  You turn your head to see nothing. Did the wind make that noise or...?  A tingling on your leg makes your hand snap to it, making a wet noise as you feel something moist on your body.  You smear it over your fingers and bring it to your nose to smell.  It's blood, though you don't remember getting injured there... but it's possible you forgot.  Did you?");
			outputText("\n\nA snap of a twig nearby makes it clear you aren't alone.  Goosebumps crawl up your skin as you turn to the source, behind a large tree.  You wonder how long it's been... there is something about it seems off.  A shadow moves behind the tree,  you're fairly sure it was something more than the moonlight confusing your vision.  Summoning your courage, you move towards the tree, fists at the ready since you're unarmed.  You touch your hands to the bark, it's warm... why?  Another snapping noise on the other side of the wide trunk distracts your attention. With a deep breath you move around the trunk to... nothing.");
			...
			outputText("\n\n\"<i>Trick or treat?</i>\"  A hollow voice taunts loudly enough to echo in your ears.  You try not to scream you remove yourself from it's grasp.  Your foot rams painfully against a root, causing you to bleed from your toe.  You land in a pile of leaves on the ground with a curse on your lips and turn your body around in a panic.  The figure stands over you.  The finest of suits cover it's body, leaving only the flaming pumpkin for it's head.  \"<i>Trick... or treat?</i>\" it asks again as it moves for you laying form.");
			outputText("\n\nYour scream that you don't understand, saying you don't have anything on you.  The figure's hand lazily raises and points a finger skyward.  The moon overhead, casting it's pale white light down over the branches, dozens of hanging creatures hang lifeless in it's branches a droplet of blood hits your cheek.  \"<i>Trick...</i>\" is all you can hear over your terrified screams as the figures falls down on you, it's hands on your neck.");
			outputText("\n\nYou launch yourself up right, screaming out as sweat covers your body.  You are alone in the middle of your camp, right where you went to sleep. Slowly you realize you must have had a nightmare.  You recall how real it felt as you rub at your neck.  You get to your feet and wince as pain shoot up your leg, looking down you see your toe bleeding.");
		}
		else if(daydream == 15) {
			...
			if(player.gender <= 1) {
				...
				//Male Trap Dream #2: 
					...
					outputText("\n\n\"<i>Come on sis, hurry!</i>\"  The young girl pulls on you with surprising strength, you don't have any time to collect yourself as you are tugged along through some sort of mansion.  Various elaborately decorated hallways and rooms flash by you, only able to catch glimpses of of each room's contents.  You try not to stumble and trip over your lovely dress as you follow the strange girl.  \"<i>They set everything up nearly an hour ago, but they have been waiting for you, of course.  I reminded you to set the alarm.</i>\" You say something of an apology to the young girl, she seemed so distressed at everything.  You couldn't help but feel guilty.");
					outputText("\n\nThe pair of you each a room with a spiralling staircase, you are tugged along a bit slower as you descend down with her.  Things grow darker and darker, but you can always see thanks to the light of the candles littering your path.  \"<i>Almost there, I hope they aren't too cross with you.</i>\" she comments as you reach the bottom of the stairs.  She opens a door what was a simple stone hallway lit up by candle light.  The only thing in the long hallway was another door at it's end.");
					outputText("\n\n\"<i>Hurry up now they have been waiting.</i>\" she nudges you through the door before closing it behind you.  It's impolite to have people waiting on you, you think to yourself.  Your mind races trying to remember what it is you forgot.  It was important, the young lady was quite upset after all.  Your cute buckled shoes click over the stone as you walk down the hallway, your frilly dress flutters just above the ground. Stopping just before the doorway your hand reaches out, pulling with a sharp yank of your arm.");
					outputText("\n\n\"<i>It's about time little miss.</i>\" a voice calls from inside as you walk in.  The room is well lit and plush, pillows and cushions scattered everywhere, all lit up by a large chandelier hanging overhead.  Though your attention is on everyone in the room, dozens of young ladies with long styled hair in various forms of underwear.  Some wearing striped stockings up to their thighs, all kinds of panties from simple white to frilled with colors.  Some wearing little bras, and other wearing lace gloves that extend past their elbows.  All kinds of cute designs on their little outfits.  Though you slowly realize that they aren't girls at all, they are all grown men with bodies warped to look like young girls.  A bulge in every panty.");
			...
			//Dream about living in a borrow and having lots and lots of kids.  Many furred, big eared bodies are running around and you feel the pregnant belly of your mate, or feel your own pregnant belly.
				...
				outputText("You have a great larder, able to feed everyone as much as they need, it has never been a problem to keep it full.  A veritable paradise for a rodent such as yourself.  Then you find your way into the master bedroom, you see it's massive bed, the site where your great family was brought into existence.\n\n", false);
...
public function dayTenDreams():void {
	...
	if(player.hasCock()) {
		if(player.cor < 50) {
			...
			outputText("As your mother laps at your shaft, coated in her juices, you look confidently down at her belly.  Though you love your mother, you're looking forward to having a daughter, training her to love you just as much as a mother does. One day, perhaps even to replace her.\n\n", false);
