...
package classes.Scenes.Areas.Mountain
{
	...
	public class HellHoundScene extends BaseContent
	{
		...
		public function hellhoundRapesPlayer():void
		{
			...
			outputText(" and positions himself behind you. He grips you with his clawed hands on your shoulders and easily holds you in place. The powerful creature is easily able to get past your " + player.armorName + " and you feel one of his rods brush against your " + assholeOffLimits(vaginaDescript(), buttDescript()) + ".  A shudder shoots through your body as he brings his two heads down to either side of your own, his hot canine breath blowing past your ears. He stays there for a few moments, completely still... before suddenly pulling his heads back and ", false);
			if (player.vaginas.length > 0 && player.lowerBody != LOWER_BODY_TYPE_NAGA) outputText("slamming his twin dicks into your " + vaginaDescript(0) + assholeOffLimits("", " and your " + assholeDescript()) + ".  ", false);
			...
			if (player.vaginas.length > 0 && player.lowerBody != LOWER_BODY_TYPE_NAGA) {
				if(assholeOffLimits()) {
					if (player.vaginalCapacity() > monster.cockArea(0) + monster.cockArea(1)) outputText("You feel an intense pleasure as your " + vaginaDescript(0) + " is filled with the creature's large members.  ", false);
					else outputText("Your lower body explodes with pain as the hellhound forces himself in too quickly for your " + vaginaDescript(0) + " to handle.  ", false);
					if (player.vaginas[0].virgin) outputText("<b>You are no longer a virgin!  </b>", false);
					if (player.cuntChange(monster.cockArea(0) + monster.cockArea(1), false)) outputText("The beast howls as your " + vaginaDescript(0) + " is stretched to accommodate the large shafts.  ", false);
				}
				else {
...
//Merae's Lethicite
		...
		public function hellHoundPropahRape():void
		{
			...
			//--- ELSE (CORRUPTION >= 20) ---
				...
				outputText("The musky scent sends pleasure all over your body, moistening your " + vaginaDescript(0) + ". You decide the foreplay is over and remove the lower part of your " + player.armorName + ". You stroke both members, bringing them to full, overly-erect state. You grab [if (assholeOffLimits = true) the pair of them, pushing their pointy tips together, and carefully position your now soaking vagina over them. You rub the pre-dripping cone-shaped rods into your entrance, wetting yourself further before you begin to sink down on the oversized bundle of throbbing dog-meat.|one of them while you carefully position your butt over the first mastiff-like dong. Its pointy tip pushes against your asshole. Relaxing your sphincter, the pre-dripping cone-shaped rod easily slides into you. Having the first penis halfway buried into your ready asshole, you stop. Struggling with your balance, you grab the hellhound's other throbbing member, guiding it to your now soaking vagina.] Slowly you let yourself down, impaling yourself on his gorgeous twin members.  ", false);
				if(assholeOffLimits()) {
					player.cuntChange(monster.cockArea(0) + monster.cockArea(1), true, false, true);
				}
				else {
				...
				outputText("  Riding the hound for a couple of minutes, you feel the [if (assholeOffLimits = true) dicks in your [vagina] extending, giving you a good stretching|dick in your " + assholeDescript() + " extending, giving you a good stretching. Its brother in your " + vaginaDescript(0) + " does the same], pushing more and more girl-fluids out of your slippery slit while stimulating your sensitive clit from the inside. You lean forward, running your hands through your fuckpet's dense midnight black fur, feeling his animal body warmth. The hellhound is moaning and panting beneath you, unsure whether to fear you or to enjoy what you are doing to him.\n\n", false);

				//--- IF PC HAS PENIS ---
				if (player.hasCock()) {
					outputText("His canine cock in your [if (assholeOffLimits) vagina|anus] stimulates your prostate perfectly. His exotic black dong applies pressure in parts of your body you wouldn't expect to get such pleasure from.", false);
					//--- IF ONE PENIS ---
				...
				outputText("Way too early, the two doggie pricks stuffed inside you start to twitch, unloading four balls worth of spunk into you. In ecstasy, the hellhound's eyes look in four different directions. The dual eruptions in your love-canal [if (assholeOffLimits = false) and rectum] feel amazing as they pulse in and out of sync, dumping cum into your [if (assholeOffLimits = true) womb|body] over and over.  The hellhound's contractions ebb away as he finishes, but you're not done yet. You slowly start tilting your hips back and forth, continuing to fiercely fuck the [if (asshole OffLimits = true) pair of members|prime member while the other rests nearly motionless in your ass]. Soon the hellhound whines from the unwanted stimulation of his now sensitive pricks, but he is too defeated to put up much of a struggle.\n\n", false);

				outputText("Slowly but steadily you bring yourself to the verge of orgasm. The hellhound under you squirms and tries to get free, his hind legs flailing through the air behind your back. You keep riding his magnificent member, grinding it up and down in your moist cave. Finally you feel the familiar rippling of your vaginal walls, milking his cock[if (assholeOffLimits = true) s] and intensifying your pleasant sensations. Clamping down on his members, you keep moving your hips in a circling motion, working your clit[if (assholeOffLimits = true) and vagina|, vagina and butt] in equal measure. The sensations eventually grant you an intense orgasm while the hellhound's still-distended members apply the perfect pressure to all of your sensitive spots and prolong your bliss.", false);
				//--- IF PC HAS PENIS ---
