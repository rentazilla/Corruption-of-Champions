...
private function badEndPartTwo():void {
	...
	if(kaijuCock()) {
		...
		if(player.assholeOffLimits()) {
			player.cuntChange(500,true,true,false);
		}
		else {
		...
		if(player.hasVagina() && !assholeOffLimits()) outputText("  Even if your cunt is empty, there is no free space left there, your cunt walls forced together like glue.");
