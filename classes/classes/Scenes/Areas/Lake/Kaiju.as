...
=======
		outputText("\n\n\"<i>Do you feel it working yet?  Can you guess what it did?  I’ll give you a hint,</i>\" the giantess says, a mad look of lust in her eyes as she gazes at your nude, helpless form.  It appears the turtle girl you know is gone, completely taken over by her libido.  She " + player.assholeOffLimits("lifts you up", "turns you around") + " and you suddenly feel the giant head of her dick resting on your " + player.assholeOffLimits("mound", "[butt]") + ".  Why is she rubbing your " + player.assholeOffLimits("cunt", "ass") + " with her dick, she knows it won’t fit right?  It’s bigger and wider than your whole body!");
		outputText("\n\nAnd that’s when you feel the impossible.  Your " + player.assholeOffLimits("[vagina]", "asshole") + " expands, gently giving ground to the leviathan at your " + player.assholeOffLimits("entrance", "backdoor") + " as you feel your hips part and stretch away from each other.  Her magic pink cum has turned you into the most elastic fuck toy in the land!  Oh, this is just too wrong.");
		if(player.assholeOffLimits()) {
			cuntChange(500,true,true,false);
		}
		else {
			buttChange(500,true,true,false);
		}
		outputText("\n\nSuddenly her entire cockhead enters your " + player.assholeOffLimits("cunt", "ass") + ", stretching you out obscenely.  You orgasm instantly.  You might handle " + player.assholeOffLimits("cock", "anal") + " better than this under normal conditions, but then there’s nothing normal about taking something this huge.");
>>>>>>> ed2dd65... Alter a couple more scenes for vaginal variants
		if(player.hasCock()) outputText("  You prostate is pressed down like a button, and there’s just no letting up!");
		if(player.hasVagina() && !player.assholeOffLimits()) outputText("  Even if your cunt is empty, there is no free space left there, your cunt walls forced together like glue.");
		...
		outputText("\n\n\"<i>Cum!  Cumcumcumcum!  Cumcum!  Cum!</i>\" shouts the giant herm, her words falling on your dim mind with a tugging familiarity.  You feel like you should be afraid for some reason... understanding suddenly crashes in on you as your body suddenly expands further, bloating out like some impossible cum balloon.  You can’t even see the ground for your cum stretched belly.  Sperm flows " + player.assholeOffLimits("around her cock", "out of your mouth") + " like a waterfall, her massive ejaculation finally finding a way out.");
		outputText("\n\nSome minutes pass before she finally takes you off her dick.  A veritable river of spunk flows " + player.assholeOffLimits("from between your legs", "out your back end") + " as you shrink and snap back to your former size.  Well, almost your former size, you still look pregnant with minotaur triplets and your " + player.assholeOffLimits("fuck", "ass") + "hole is stretched beyond repair.");
	}
	...
	outputText("\n\nThe first planty-cock hits your ass like a switch, spanking your [butt] till your cheeks are blushing red before the tip snuggles up to your puckered sphincter" + player.assholeOffLimits(" and tears out the plug within it") + ".  It wriggles wildly, working itself up in ecstatic anticipation, or at least the plant-like version of anticipation, drippy vine-pre-seed lubing up your hole before pushing forth with all its might, meeting only a little resistance before the pressure and fluid mixture eases it into your [butt].");
