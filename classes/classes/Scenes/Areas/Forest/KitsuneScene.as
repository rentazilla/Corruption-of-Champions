...
//Formerly shoveHer()
		private function kitsuneShoveHerMansion(willing:Boolean = true):void
		{
			...
			if (player.gender == 1 || ((player.gender == 3) && flags[kFLAGS.redheadIsFuta] == 0)) {
				...
				outputText("You feel something brushing against you and look down to find the black-haired girl pressing her face against [if (assholeOffLimits = true) the small of your back|your [butt]], running her hands up and down your " + hipDescript() + " and smacking your [if (assholeOffLimits = true) ass]cheek once lightly for good measure.  An involuntary shudder zigzags up your spine as her slick tongue runs up your [if (assholeOffLimits = true) spine|crack, lining your [asshole] with saliva].  Her fingertips dig into the flesh of your bottom, the other hand sliding along your " + vaginaDescript() + ", pinching and rolling your " + clitDescript() + ".  A moment later, you rise an inch or two off the ground as a [if (assholeOffLimits = true) pair of fingers spear your [cunt]|squirming invader spears your ass].  Her plush lips press against you like soft pillows, [if (assholeOffLimits = true) giggling as she slides her slim, clever fingers within you|a muffled giggle vibrating up her tongue and into your prostate].  Your strength gives out as she prods your prostate[if (assholeOffLimits = true)  through your vaginal wall on the way back to your clit], dragging you down with her weight [if (assholeOffLimits = false) at the same time ]to impale you on the redhead's cock.");
				//[virginity loss/ stretching, redhead is 12x2]
				player.cuntChange(24, true, true, false);
				outputText("\n\n");
				outputText("The redhead squeals with pleasure as her throbbing shaft spears your nethers, her hands rising up to the blonde's shoulders and digging into them passionately.  Caught between the blonde's sopping pussy, the redhead's cock, and the ravenette's [if (assholeOffLimits = true) clever fingers|swirling tongue], you are ensconced in such pleasure that you can no longer distinguish the source.  Your body bucks and trembles from the trio's indulgent onslaught, hips grinding and mashing against each other in a passionate spectacle.\n\n");
...
// lose, requires balls and cumQ() > 1000
		private function loseToKitsunesWithBallsAndHighCumQ():void
		{
			...
			outputText("As if to demonstrate her supreme skill with her tongue, she allows her hands to wander freely along your lower body while she continues to bounce and squeeze your balls with her tongue.  " + ((player.gender == 3) ? "The tip snakes down, hugging the curvature of your balls, and then begins to experimentally prod your " + vaginaDescript() + ", gently flicking your clitoris.  " : "" ) + "Pleasure turns to surprise when you feel her index finger poking around by your " + assholeOffLimits(vaginaDescript(), assholeDescript()) + ", and she buries it to the base inside you before you have a chance to formulate a protest.  The sudden intrusion makes your shaft flex, the veins bulging against the surface of the skin as it swells a bit in response.\n\n");
			outputText("The wriggling digit finds its way to your prostate and wastes no time going to work, rubbing against you from [if (assholeOffLimits = true) inside your cunt|the inside] while she lavishes attention on your balls.  Her free hand glides up and down your shaft, and she occasionally pauses to affectionately nuzzle the underside, rubbing her cheeks along it.  The combination of all these factors is enough to bring you to the verge of climax in just minutes, her skillful licking and stroking sending you to incredible heights of pleasure.  Just as you are about to achieve release, her hand strangles the base of your cock with a vicelike grip, blocking the flow.\n\n");
...
//[Tribbing] - requires vagina
		private function tribbingWithAKitsune():void
		{
			...
			outputText("Like a coiling spring, a tension slowly culminates in your intermeshed netherparts, climbing steadily as a path of heat radiates through your womb.  You lurch forward, a moan catching sideways in your throat as you feel a slender finger sliding up against your [if (assholeOffLimits = true) [cunt]|[asshole]], gently wriggling its way inside.  The addition of this intruder has you near the limits of your endurance, trembling with restraint and digging your fingers deeper into the soft, voluptuous doughiness that is her breathtaking backside.  Deciding to return her kindness, you circle her [if (assholeOffLimits = true) dripping gash|tensed pucker] with a fingertip, plunging it in up to the knuckle.  Her [if (assholeOffLimits = true) entrance welcomes|anal ring spreads around] your finger without quarrel, the warmth of her [if (assholeOffLimits = true) vagina|rectum] drawing the invasive digit inside invitingly" + assholeOffLimits("", (player.clitLength > 4) ? ", and her vagina immediately tense around your [clit] in response, trapping it in a vacuumlike suction" : "")) + ".\n\n");
