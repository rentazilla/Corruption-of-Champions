...
package classes.Scenes.Areas.HighMountains
{
	...
	public class BasiliskScene extends BaseContent
	{
		...
		private function basiliskAdvantageMinotaur():void {
			...
			if(assholeOffLimits()) {
				outputText("The huge bull-man is not one to look a gift fuck in the mouth.  Without bothering to take you in, bar a long wet sniff of your " + hairDescript() + ", he sticks his cock between your legs.  He grunts as he forces his head past your entrance, squirting pre-cum into your passage as he does so.  Your body is incapable of clenching instinctively against the invasion, but there is no escaping how huge the dong feels as he impatiently forces your cunt open.", false);
				...
				outputText("  You begin to pant from exertion and the overpowering sensation of the fuck as you feel first one ring and then a second push past your lower lips, then out again, then in and out as the minotaur picks up the pace.  As rut takes hold of him, he picks you up by your arms and uses his strength to force you up and down his dick, using you as a cocksleeve to sate his animalistic desires.  Your cunt is dripping with his pre-cum by now however, and the drugged slime has bumped you upwards into a hazy high; only the thump of his flat head against your cervix when his dick is completely buried in your cunt brings you out of it, the painful intensity of it dragging you down of your cloud with a gasp.\n\n", false);
