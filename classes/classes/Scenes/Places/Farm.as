...
public function cockPumping():void {
	...
	if(player.hasKeyItem("Cock Milker: Anal Attachment") >= 0) {
		if(player.cockTotal() == 1) outputText("A sudden splash of wetness hits your " + assholeOffLimits("mound", "backside") + ", instantly soaking your " + player.skinDesc + " with slippery lubricants.  You feel something narrow " + assholeOffLimits("slip into your" + vaginaDescript() + ", easily sliding deep inside you", "touch against your " + assholeDescript() + ", workings its way past the clenching muscles and into your body") + ".  The violation would bother you more if it didn't seem to amplify the feelings radiating down your shaft, but then it starts to change.  You feel it swelling up inside, somehow inflating.  It stretches you wide, pressing against the knot of your prostate" + assholeOffLimits(" through your vaginal wall") + ", milking out a thick flow of cum.   It pushes tighter and tighter, making you drip and drizzle in a steady flow before deflating, allowing your abused body to relax.  You sigh, but are kept rock hard by the feverish milking of your dick.\n\nEventually the probe inflates again, squeezing out another drizzle of thick spooge, the hose on your " + cockDescript(0) + " noisily sucking it down.  You're kept like that for quite a while – never feeling a true orgasm, but forced to expel cum over and over by always increasing waves of pressure in your " + assholeOffLimits("cunt", "ass") + ".  You babble incoherently, pleasure-drunk, not even noticing a green light on the far side of the wall come on.  One thing you do notice is that the cock-tube isn't slowing down its ministrations.  You're finally allowed to cum!\n\n", false);
		else outputText("A sudden splash of wetness hits your " + assholeOffLimits("mound", "backside") + ", instantly soaking your " + player.skinDesc + " with slippery lubricants.  You feel something narrow " + assholeOffLimits("slip into your" + vaginaDescript() + ", easily sliding deep inside you", "touch against your " + assholeDescript() + ", workings its way past the clenching muscles and into your body") + ".  The violation would bother you more if it didn't seem to amplify the feelings radiating down your shafts, but then it starts to change.  You feel it swelling up inside, somehow inflating.  It stretches you wide, pressing against the knot of your prostate" + assholeOffLimits(" through your vaginal wall") + ", milking out a thick flow of cum.   It pushes tighter and tighter, making you drip and drizzle in a steady flow before deflating, allowing your abused body to relax.  You sigh, but are kept rock hard by the feverish milking of your dicks.\n\nEventually the probe inflates again, squeezing out another drizzle of thick spooge, the hoses on your " + multiCockDescriptLight() + " noisily sucking it down.  You're kept like that for quite a while – never feeling a true orgasm, but forced to expel cum over and over by always increasing waves of pressure in your " + assholeOffLimits("cunt", "ass") + ".  You babble incoherently, pleasure-drunk, not even noticing a green light on the far side of the wall come on.  One thing you do notice is that the cock-tubes are no longer slowing down their ministrations.  You're finally allowed to cum!\n\n", false);
	}
	//(ELSE)
	else {
