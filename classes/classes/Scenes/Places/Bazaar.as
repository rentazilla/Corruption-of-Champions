...
private function joeysMassageWifNoExtraJizz():void {
	...
	if(player.hasCock()) {
		...
		outputText("gentle fingertips are probing between your " + player.assholeOffLimits("legs", "cheeks") + ", rubbing his dripping seed against " + player.assholeOffLimits("the steamy entrance to your" + vaginaDescript(), "the pucker of your " + assholeDescript()) + ".\n\n", false);
	}
	//(FEM/GENDERLESS) 
	else {
	...
	//(Dickgasms
		...
		outputText("Though Joey's mouth is making you burn with passion, it's the feeling of a single, intruding fingertip against your " + player.assholeOffLimits(vaginaDescript(), assholeDescript()) + " that puts you on edge.  His warm jism slides down his finger, dripping into your violated " + player.assholeOffLimits("pussy", "backside") + " with each slow pump.  Once you've adjusted, he continues the " + player.assholeOffLimits("vaginal", "rectal") + " massage, gently caressing the sides of your prostate while his mouth stays busy with your " + cockDescript(0) + ".  The bunny's tongue thrashes, twisting like a slippery eel over your length, his cheeks hollowing from the suction he's applying.  A moment later, Joey curls the digit inside you to press firmly against your prostate, squeezing the sensitive organ tightly enough to make your hips pump into the air.\n\n", false);
...
private function joeysMassageWithEXTRASpooge():void {
	...
	outputText(" while he grinds and cums on your " + cockDescript(0) + ".  \"<i>Ungg... yes... gotta... squeeze... allofitooooouuuuut!</i>\" he pants.  He lets go of one tender nipple to reach underneath you, and before you can react, his cum-soaked finger is inside your " + player.assholeOffLimits(vaginaDescript(), assholeDescript()) + ", pressing on your prostate.\n\n", false);
...
private function eggsInButt(eggButt:Boolean = false):void {
	...
	if(eggButt) {
		if(player.assholeOffLimits()) {
			outputText("You nod your head to the little femboy, who jumps with joy, splattering a little string of chocolate cum across the floor.  He walks around behind you and asks you to get up on all fours with your legs spread.  You do so, surprised to find you can move after that initial massage, feeling the steamy air caress your slit.  You can't see what he's doing back there, but when you feel a warm splash of liquid against your [vagina], you let your mind's eye go to work.");
			outputText("\n\nJoey gathers up another dollop of the chocolatey cum and smears it across your entrance. Then he takes two fingers and gently prods inwards, sinking in knuckle-by-knuckle.  He works the two fingers in, pumping and sliding them around, coating your walls with his jizz.  When the bunny-boy retracts his fingers, you find yourself aching for his touch, wanting something, anything, inside you.  You don't want for long, of course, as Joey retrieves the giant painted egg and presses it up against your empty [vagina].  He pushes it forward, your cum-lubed pussy parting to make way.  It stretches you further and further outwards, nearing discomfort levels, but then you round the widest point and your [vagina] devours it with a wet <i>schluck</i>, pulling it so deeply inside that it presses lightly against the entrance to your womb.");
			outputText("\n\nJoey rubs your cunt some more, working his little masseuse fingers all over, helping it to relax once more.  You feel so deliciously full with that egg inside you, like you have a giant cock constantly fucking you.  It gives you a little thrill to know that both of you are packing this monster of an egg inside of you, and that he's feeling the same things you are.  You lower your legs and ass marveling at the sensations of the egg shifting around.\n\n");
		}
		else {
