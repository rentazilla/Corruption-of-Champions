...
private function joeysMassageWifNoExtraJizz():void {
	...
	//(Dickgasms
		...
		outputText("Though Joey's mouth is making you burn with passion, it's the feeling of a single, intruding fingertip against your " + player.assholeOffLimits(vaginaDescript(), assholeDescript()) + " that puts you on edge.  His warm jism slides down his finger, dripping into your violated " + player.assholeOffLimits("pussy", "backside") + " with each slow pump.  Once you've adjusted, he continues the " + player.assholeOffLimits("vagina", "rectal") + " massage, gently caressing the sides of your prostate while his mouth stays busy with your " + cockDescript(0) + ".  The bunny's tongue thrashes, twisting like a slippery eel over your length, his cheeks hollowing from the suction he's applying.  A moment later, Joey curls the digit inside you to press firmly against your prostate, squeezing the sensitive organ tightly enough to make your hips pump into the air.\n\n", false);
