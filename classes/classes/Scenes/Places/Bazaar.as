...
private function joeysMassageWifNoExtraJizz():void {
	...
	if(player.hasCock()) {
		...
		outputText("gentle fingertips are probing between your " + assholeOffLimits("legs", "cheeks") + ", rubbing his dripping seed against " + assholeOffLimits("the steamy entrance to your" + vaginaDescript(), "the pucker of your " + assholeDescript()) + ".\n\n", false);
	}
	//(FEM/GENDERLESS) 
	else {
	...
	//(Dickgasms
		...
		outputText("Though Joey's mouth is making you burn with passion, it's the feeling of a single, intruding fingertip against your " + assholeOffLimits(vaginaDescript(), assholeDescript()) + " that puts you on edge.  His warm jism slides down his finger, dripping into your violated " + assholeOffLimits("pussy", "backside") + " with each slow pump.  Once you've adjusted, he continues the " + assholeOffLimits("vaginal", "rectal") + " massage, gently caressing the sides of your prostate while his mouth stays busy with your " + cockDescript(0) + ".  The bunny's tongue thrashes, twisting like a slippery eel over your length, his cheeks hollowing from the suction he's applying.  A moment later, Joey curls the digit inside you to press firmly against your prostate, squeezing the sensitive organ tightly enough to make your hips pump into the air.\n\n", false);
...
private function joeysMassageWithEXTRASpooge():void {
	...
	outputText(" while he grinds and cums on your " + cockDescript(0) + ".  \"<i>Ungg... yes... gotta... squeeze... allofitooooouuuuut!</i>\" he pants.  He lets go of one tender nipple to reach underneath you, and before you can react, his cum-soaked finger is inside your " + assholeOffLimits(vaginaDescript(), assholeDescript()) + ", pressing on your prostate.\n\n", false);
