...
private function keltMainEncounter3():void {
	...
	//NAKERS
		...
		if(temporary == 4)
		{
			...
			outputText("Thrown off guard by his aggressive attitude, you hastily stand, and at his command, face the target, trembling slightly. Kelt looms over you from behind, and grabs you roughly by the hair.  Then, with his other hand, he crudely shoves two fingers up your " + assholeOffLimits("cunt", "ass") + ".  You let out a cry of shock, but Kelt growls and tightens his grip on your hair.\r\r", false);
			outputText("\"<i>THERE.  Is that what you fucking wanted, whore?  Something nice to fill that " + assholeOffLimits("cunt", "ass") + " of yours?  Bet it feels good, huh? Bet you were fucking DREAMING of a nice, fat cock up your " + assholeOffLimits("cunt", "ass") + ".  Well, here you go!  Feel better now that you're being fucked, slut?</i>\"\r\r", false);
			...
			outputText("\"<i>Okay.  Now that our little bitch is getting " + assholeOffLimits("a fingerfuck", "an assfuck") + ", maybe she'll be satisfied enough to hit the fucking target.  Now shoot... and don't you dare fuck this up again.</i>\"\r\r", false);
...
private function keltMainEncounterPostBlowjob():void {
	...
	if(player.findStatusAffect(StatusAffects.BlowjobOn) >= 0) {
		...
		if (player.lust >= 75 || player.statusAffectv2(StatusAffects.Kelt) >= 90 && rand(2) == 0) {
			...
			outputText("Lying on the rough table with your feet in the stirrups, your " + assholeOffLimits("cunt", "ass") + " is suspended at just the right height.  Kelt moves with obvious hunger, running his finger along your nethers.", false);
			//(Penis:
			...
			outputText("You flinch slightly as his two front hooves land forcefully on either side of your head, as Kelt mounts you from behind.  You can feel his massive cock pressing firmly " + assholeOffLimits("against your front, smearing a warm little blob of precum " + (player.breastRows.length > 0 ? "between your breasts" : "across your chest"), "into your back, drooling a warm little blob of precum between your shoulder blades") + ". For a few, anxious moments, you tremble and bite your lip, waiting for him to line up his shot.  You almost cum on the spot as the flared head of his member presses squarely between your " + assholeOffLimits("nether lips", buttDescript()) + ".\r\r", false);
			outputText("Kelt doesn't hesitate.  With an almost primal snarl, he rams his cock forward, anxious to sink himself deep into your " + assholeOffLimits("cunt", "ass") + ".  With no lube and no foreplay, you let out a cry as the massive cock splits you open.  Fortunately, it drools precum eagerly into your " + assholeOffLimits("depths", "backside") + ", making the next thrust easier, though no less forceful.  Kelt shows no mercy, trying to fit himself inside your ");
			...
			//(Vagina:
			if(player.hasVagina() && !assholeOffLimits()) outputText("  Your poor, neglected pussy quivers with delight, convulsing without even being touched.  Thick juices run freely down your leg, dripping off to splatter the hay below you as you moan like a bitch in heat.", false);
			//(Genderless: 
			...
			outputText("\r\rIf anything, your orgasm only seems to spur Kelt on, causing him to push deeper and faster.  The idea of fitting his massive, nearly three-foot cock into your " + assholeOffLimits("womanhood", "bowels") + " seems ludicrous, but the aggressive centaur obviously has no intention of taking 'no' for an answer.  With each powerful thrust of his hips, he sinks more cock deep within your " + assholeOffLimits("cunt", "ass") + ", filling you, stretching you, ripping you open with still more to come.  It is almost a terrible relief when you feel his massive testicles collide with your " + assholeOffLimits("clit", "ass") + ", buried at last to the hilt. Even in victory, Kelt is snide.  ", false);
			if(player.looseness(assholeOffLimits()) < 3) outputText("\"<i>Fuck!  About time!  Sure got a tight little " + assholeOffLimits("cunt", "ass back") + " here, but don't worry, slut.  We'll stretch it out in no time. I promise you this... you'll be getting a lot more of my cock from now on, so you'd better be ready!</i>\"\r\r", false);
			else if(looseness(assholeOffLimits()) < 5) outputText("\"<i>Fuck!  About time!  Sure got a nice " + player.assholeOffLimits("cunt", "ass back") + " here, but don't worry, slut.  We'll turn it into a real gaper soon.  It's a good thing you've been practicing... you'll be getting a lot more of my cock from now on, so you'd better be ready!</i>\"\n\n");
			else outputText("\"<i>Fuck!  About time!  Sure got a nice, stretched out little " + assholeOffLimits("pussy", "pucker back") + " here, but don't worry, slut.  I'll train into to squeeze down just right in no time.  I promise you this... you'll be getting a lot more of my cock from now on, so you'd better be ready!</i>\"\n\n");
			outputText("You lose track of time, moaning and whimpering beneath your master as he ruthlessly takes his pleasure from your distended " + assholeOffLimits("cunt", "ass") + ".  Did you cum again?  Almost certainly... but it is hard to focus on that one sensation.  The much greater sensation welling up within you is a sense of rightness.  This is where you belong; this is where you are happy.  As his cock begins to swell within you, preparing to unload his spunk deep inside, your voice rises in a cry of jubilation.  Impaled upon your master's cock, now and forever, being filled with his seed... you could want nothing more.\r\r", false);
			outputText("The torrent of jizz is pumped into you lewdly, Kelt's heavy testicles blasting burst after burst into your " + assholeOffLimits("womb", "bowels") + ", filling your belly with hot centaur cum.  " + assholeOffLimits("He doesn't relent until well after your womb has been filled to the point of making you ache... you at one point feel a dollop dripping out of you, only to try weakly to hold it in.", "He doesn't relent until well after your ass has been filled to the point of making you sick... you at one point cough up a mouthful of his cum, only to try weakly to swallow it back down.") + "  It is your master's cum... it belongs inside you.\r\r", false);
			outputText("When Kelt pulls out, he leaves behind your ravaged " + assholeOffLimits("fuckhole", "asshole") + ", spread wide and filled with cum.  You whimper as he withdraws, but are unable to move, unable to think.  You dimly hear him laughing at you again, and taste his cum " + assholeOffLimits("", "once more ") + "as he dips a finger into your gaping " + assholeOffLimits("cunt", "asshole") + " and presses it to your lips.\r\r", false);
			...
			outputText("It's some hours later before you rouse yourself, clenching your " + assholeOffLimits("cunt", "ass") + " as best as you can to keep the tide inside.  Despite your efforts, a steady trail oozes down your leg, marking your path as you slowly, happily trudge back to your camp.", false);
			doNext(14);
			player.slimeFeed();
			//(+10 Submissiveness)
			if(assholeOffLimits() ? player.cuntChange(70,true) : player.buttChange(70,true)) outputText("\r\r", false);
			player.addStatusValue(StatusAffects.Kelt,2,10);
			player.orgasm();
			dynStats("cor", 1);
			return;
