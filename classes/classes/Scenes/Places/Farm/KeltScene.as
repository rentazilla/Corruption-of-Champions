...
private function keltMainEncounterPostBlowjob():void {
	...
	if(player.findStatusAffect(StatusAffects.BlowjobOn) >= 0) {
		...
		if (player.lust >= 75 || player.statusAffectv2(StatusAffects.Kelt) >= 90 && rand(2) == 0) {
			...
			outputText("You flinch slightly as his two front hooves land forcefully on either side of your head, as Kelt mounts you from behind.  You can feel his massive cock pressing firmly " + (player.assholeOffLimits() ? "against your front, smearing a warm little blob of precum " + (player.breastRows.length > 1 ? "between your breasts" : "across your chest") : "into your back, drooling a warm little blob of precum between your shoulder blades") + ". For a few, anxious moments, you tremble and bite your lip, waiting for him to line up his shot.  You almost cum on the spot as the flared head of his member presses squarely between your " + (player.assholeOffLimits() ? "nether lips" : buttDescript()) + ".\r\r", false);
