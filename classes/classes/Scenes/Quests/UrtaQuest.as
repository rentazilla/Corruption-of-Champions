...
private function getKnockedUpWithGodChild():void {
	...
	//{Bimbo Sophie ball worship here}
		...
		if(player.balls > 0) outputText("  She does the same to your own [balls]" + assholeOffLimits("", ", even giving your [asshole] a happy, sloppy kiss before returning to") + " polishing the supple, skin-shrouded spheres just ahead.");
