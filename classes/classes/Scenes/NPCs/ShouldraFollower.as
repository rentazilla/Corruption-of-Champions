...
public function sandWitchGetsGhostly():void {
	...
	if(player.hasCock() && (!player.hasVagina() || rand(2) == 0)) {
		...
		outputText("\n\nHelping the possessed desert seductress to her feet, you query as to how to get the damnable things to stop.  \"<i>Oh...oh...t-that's easy,</i>\" Shouldra replies, her voice cracking under the persisting frontal duress.  She leans heavily on your shoulder and with a merely a snap of her fingers, the orbs finally go silent, lifelessly rolling out from their targeted orifice[if (assholeOffLimits = false) s].  Your relief is only shadowed by the incredibly odd tingling sensation left in the orbs' wake.  Peering back up at the sand witch, you find her eyes finally returned back to her normal shade of brown.  Her breathless gaze meets yours, the two of you staring at one another for a moment.");
...
private function genderlessShouldraMasturbation():void {
	...
	outputText("\n\nBut Shouldra is far from satisfied; without letting up on your current predicament, she directs your [foot] back inside her chest.  It begins indiscriminately shoving dildos of every variety up your besieged bum with undue haste.  Ectoplasmic slobber pours down your [legs] as each fun stick is switched on and added to the collection.  You think she makes it to five before her hold over your [legs] dissolves; lacking the ghost girl's willpower and gumption for ignoring simple laws of nature, you tumble to ground, a small blessing in disguise as now you at least have things to grapple onto now.  And hold on with all your might is exactly what you do; the rear onslaught is rocking your entire body as every moist rod vibrates and rolls around in the confines of the ghost's gluttonous gullet.  Your inflated mutinous cheeks do their best to contain the invasion through each escalating thrust.");
...
private function nongenderlessAnalShouldraMasturbation():void {
	...
	outputText("\n\n\"<i>If there were ever a more... appropriate time to say something profound... to say something poetic...</i>\"");
	outputText("\n\nYou can't help but be perplexed by the sudden somber shift.  Though, honestly, it was just a ruse to disarm you; the ghost girl ardently crams the sucker down her gullet, sending shivers racing up your spine.  Nearly all eight inches of coarse demon pecker burrow deep within your haunted hole; the ghoul shifts the dildo around within you, thoroughly brushing your insides with its every nodule.  Dying to continue escalating things, the phantom swings her tongue up to the base and switches on the vibrator, triggering moans from both mouths.  Your bewitched butt grasps the rod once more, thrusting it in and out of you; the combined sensations of  the pseudo oral and anal assault is as only half as confusing as it is pleasurable.");
	outputText("\n\nBut Shouldra is far from satisfied; without letting up on your current predicament, she directs your [foot] back inside her chest.  It begins indiscriminately shoving dildos of every variety up your besieged bum with undue haste.  Ectoplasmic slobber pours down your [if (isBiped = true) legs] [if (isBiped = false) form] as each fun stick is switched on and added to the collection.  You think she makes it to five before her hold over your [legs] dissolves; lacking the ghost girl's willpower and gumption for ignoring simple laws of nature, you tumble to ground, a small blessing in disguise as now you at least have things to grapple onto now.  And hold on with all your might is exactly what you do; the rear onslaught is rocking your entire body as every moist rod vibrates and rolls around in the confines of the ghost's gluttonous gullet.  Your inflated mutinous cheeks do their best to contain the invasion through each escalating thrust.");
	outputText("\n\nThe moist quivering shafts - the bizarre conglomeration of shapes - the unnatural sounds and breathing emanating from your bottom - the unending geyser of diluted ectoplasmic drool soaking your body - the unorthodox tongue rooted in your asshole lashing about - your vexed cheeks simultaneously tightening around their cargo while their abnormal mass violently jiggles about - It's all too much!");
...
private function maleMasturbationProper():void {
	...
	outputText("\n\nThe ghost girl relinquishes part of her hold on you, most likely knowing full well your new fascination with her construct.  Sure enough, as soon as you take up the reins, your efforts to reach the rose doubles.  Luckily for you, the tentacles, slimy as a swimming goo girl tentacles, are no match for your lust-driven struggle.  You slip out of their grasp, free-falling for several feet to land, with a big and airy poof, right into the cushiony bloom.  The pleasant and heady aroma of the enlarged rose nearly drives you wild.  You just can't get enough.");
...
private function groBallsBiggaGHOSTYSTYLE():void {
	...
	clearOutput();
	spriteSelect(67);
	outputText("\"<i>Interested in a bigger ballsac, huh?  Not only will it help pronounce your package, but a big ol' swinging sack of nuts feels great when you're really pounding.</i>\" Shouldra grasps your [balls] with both your hands and begins reciting the appropriate spell.");
...
private function shouldraReductosYourBallsUpInsideYa():void {
	...
	clearOutput();
	spriteSelect(67);
	outputText("\"<i>Why would you want to shrivel these delicious cumquates?</i>\"  Shouldra's arsenal of puns doesn't affect your request in the slightest.  The ghost girl moves into a quick spell, savoring your testicles before finishing.");
...
private function keepShouldraAndKickOutExgartuan():void {
	...
	outputText("\n\nShouldra's pushing Exgartuan's buttons something fierce.  Unluckily for you, the supposed demon curse is still fully ensconced on your mid-section.  Your [cock] feels like its sucking the life out of you in its rage, engorging itself with blood and pushing you to the most powerful erection you've ever laid eyes on... or had the misfortune to have.  Its actually really taxing on you as the demon wang puffs up in protest, throbbing with each heartbeat of yours.  Not only can you visibly make out veins, but you're afraid the various bumps on your member might be going haywire, too.");
