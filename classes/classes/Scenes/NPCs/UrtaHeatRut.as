...
internal function approachSoberUrtaHeatRutProc():void {
	...
	//Player in heat:
		...
		outputText("\n\nYou dispose of your [armor], your [vagina] already wet and eager for her.  You pull the vixen into an embrace under the wall of the alley, and she starts to aligning her huge, pre-cum dripping cock with your opening.");
		menu();
...
internal function approachDrunkenUrta():void {
	...
	//Player in heat:
	 ...
	 outputText("\n\n\"<i>My, my. You do realize how you smell like, don't you?  Did you think I wouldn't notice?  Or are you here precisely because you wanted me to notice?</i>\"");
...
private function soberUrtaSatingPCHeat():void {
	...
	if(player.hasCock()) outputText("[cock biggest]");
		...
		else outputText("running her fingers over your entire big clit before stroking it like sheâd do with a cock");
	}
	...
	if(!urtaQuestDone()) {
		if(!urtaLove()) outputText("\n\n\"<i>We are safe.  No matter how much sticky goo I pump into you, you shouldnât get pregnant.</i>\"");
...
private function sateRutWithSoberUrtaButHuegDicked():void {
	...
	//Lover Urta Path/
		...
		outputText("\n\nShe pulls her head free and gasps for breath, looking at you in admiration. \"<i>By Marae... how do you manage to do this for me, lover?</i>\" she asks, stunned.  But then, gamely, she returns her attention to your " + cockDescript(x) + ", licking and suckling and mouthing at the head.  As she does this, she continues her restless assault with her hands upon the rest of your lengthy shaft with her skilled hands.  She shuffles closer, allowing you to rest yourself between her DD-cups.  \"<i>Can you feel how fast my heart is beating through your cock?  You turn me on so very much,</i>\" she purrs.");
...
private function sateRutWithSoberUrta():void {
	...
	outputText("\n\nWell, you don't intend to keep the lady waiting any longer then you have to, and slide it home, allowing her testicles to drop once you are safely inside.  The globular organs bounce atop your " + cockDescript(x) + " and rock back and forth against your belly, jiggling with every movement the two of you make, Urta's cock sandwhiched firmly between your bodies and held between her breasts.");
	...
	if(urtaLove()) outputText("  Her hips deliberately sway in a mesmerising fashion, tail flicking from side to side to give you a tantalizing grip of her still-dripping snatch and the now-flaccid prick underneath.");
...
private function sateRutWithDrunkUrtaWithHugeDick():void {
	...
	outputText("\n\nSometimes, this thing can get so big it's essentially useless, you dumbass.  Hell, I'd know that, and I'm smaller than your are!");
	...
	outputText("\n\nShe hops off the table with unusual grace and agility for someone after a few drinks and covered in cum, and walks to the table to pay her bill.  Contrary to her words, it she appears to look somewhat sad and disappointed, both in you and herself.");

	outputText("\n\nRealizing thereâs no point in talking to her and just somewhat sated, you return to your camp.");
...
private function drunkUrtaRidesARutPCsCock():void {
	...
	outputText(".  As you discharge, the fox's pussy starts squeezing and contracting, and you recognize the hermaphroditeâs own orgasm.  Thicker white liquid suddenly drips from the tip of her cock quite copiously and occasionally shoots out into the air.");
	...
	outputText(".  Summoning your slightly exhausted strength, you pull her hips down deeper into your own before starting to return the hermaphroditeâs shakes and bounces with thrusts of your own.  It intensifies the sensations and making your lover yelp in surprise before smiling widely and releasing low, content moans and purrs from the depth of her throat.");
	...
	//[Regular Urta]
	if(!urtaLove()) {
		outputText("\n\n<i>Now ainât I just the best fuck you ever had?</i>\"");
	}
	//[Lover Urta]
	else outputText("\n\n\"<i>Come on, lover, you know itâll feel better once you give me even more!</i>\"");
	...
	outputText("\n\nAfter a while, it becomes a torture to resist the stimulation and you try to bring your own orgasm faster by responding to Urta's movement, stretching your [hips] and pushing your " + cockDescript(x) + " deeper into her pussy.  Although the two of you have troubles catching a common rhythm, she appears way more vitalized and enthusiastic about this than you are.");
	...
	if(player.cumQ() <= 200) outputText("  The table already seems like itâll be stained white by Urta's efforts alone, and your own fluid doesn't help the situation.");
	else if(player.cumQ() < 1000) outputText("  The two of you are already fucking in a small pool of your mixed semen sauce, naughty sounds heard all over the bar, and her vagina, dripping with your fluids, only makes the pool seem bigger.");
	...
	if(player.cumQ() >= 1000) outputText("  Well, maybe you can, but letâs make some twins!");
	...
	else if(player.tallness <= 65) outputText("\n\nBy manevouring your neck alone, you're easily able to press your lips against the tip of her erection.");
	...
	outputText("\n\n\"<i>Yes!  Fuck, Marae, this is just superb!  We'll keep fucking like this until weâre totally empty!");
	...
	outputText("\n\nYour mind is incapable of tracking what happened later.  You were pretty tired and nearly empty, but you managed another orgasm or two with the hermaphrodite riding on your erection.  You can't really remember how many orgasms she had in the meantime, what happened afterwards.  How did you leave the Wet Bitch and how did you end up with a somehow familiar roof over your head, with furs under your back and without the all-encompassing scents of sex and jizz in the air?");
...
Quote:Extinguish: As you walk away, you realise that your (heat/rut) has cooled; evidently, mating with Urta let you trick your body, so now it isn't crazed to breed. [Heat/Rut ends]

Intensify: As you walk away, you groan as you realise that you feel hornier than ever. It looks like trying to trick your body by mating with (a sterile herm/a herm who uses contraceptives afterwards) wasn't a good idea - it's only made things worse. [Heat/Rut intensifies]
