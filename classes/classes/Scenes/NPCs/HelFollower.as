...
private function femtaurPlusCampHel():void {
	...
	outputText("\n\nYou have time only to let out a desperate curse before the toy rams itself back into you.  You try to leap forward from the massive, mind-numbingly pleasurable impact, but its strong hands hold you fast.  You yelp and scream as the statue begins to fuck you roughly, making forceful thrusts deep into your [vagina] until the dildo is battering your cervix.  Its motions into you carry its second cock forward, too, slamming into Hel until her gut visibly distends under the sudden impact, forcing a scream from her lips - and a brutal thrashing of her tail, her thick shaft going wild inside your " + (player.assholeOffLimits() ? "overstuffed snatch" : "anus") + ", wriggling madly about inside you, completely out of her control.");
